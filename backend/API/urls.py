...
urlpatterns = [
    ...
    path('vehicle-receivement/<int:pk>',
         views.VehicleReceivmentTarget.as_view()),      # updatowanie targetu przez admina
    path('vehicle-receivements',
         views.VehicleReceivments.as_view()),
    path('vehicle-receivements/complains',
         views.VehicleReceivmentsComplains.as_view()),
    path('vehicle-receivements/finish',
         views.VehicleStatement.as_view()),
    path('vehicle-receivements/admin/finish/<int:pk>',
         views.VehicleStatementAdmin.as_view()),    # konczenie zlecenia przez admina
    path('vehicle-receivements/active',
         views.ActiveReceivment.as_view()),
